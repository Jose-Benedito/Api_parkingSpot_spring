...
public class ParkingSpotController {
    ...
    public ResponseEntity<Object> saveParkingSpot (@RequestBody @Valid ParkingSpotDto parkingSpotDto){
        ...
        if(parkingSpotService.existsByParkSpotNumber(parkingSpotDto.getParkingSpotNumber())){
        ...
        var parkingSpotModel = new ParkingSpotModel(); // (var) instância da classe do java 9
        BeanUtils.copyProperties(parkingSpotDto, parkingSpotModel); //conversão da model
